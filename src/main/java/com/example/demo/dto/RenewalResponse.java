...
public class RenewalResponse {
    ...
    public LocalDateTime getUpcomingRenewalDate() { return upcomingRenewalDate; }
    public void setUpcomingRenewalDate(LocalDateTime upcomingRenewalDate) { this.upcomingRenewalDate = upcomingRenewalDate; }
}